...
consumer_key = "73tXNweN3wM5a23VuvdZChLX4"
consumer_secret = "D2CwwA5CJMxGatQDeyxy9lp0afE3522MFJZwAvcASAwaIKvl64"
access_key = "1171550663857332226-sVhwnq1LsLc2lzHOvSGTkvcOqVmBaR"
...
def get_tweet(username, num_tweets):
  ...
  Someone_tweets = auth_tweet.user_timeline(
...
def hashtags(search_words, date_since, date_until):
  ...
  tweets = tw.Cursor(api.search, q=search_words, lang="en",
                     since=date_since, until=date_until, tweet_mode="extended").items(10)
...
def hashtagtweets(hash_tag, wanted_date_since, wanted_date_until):
  twitter_tag_content, twitter_tag_content_time = hashtags(
      hash_tag, wanted_date_since, wanted_date_until)
  # strip links
  i = 0
...
print("The average sentiment of", handle, "over the last",
      number_tweets, "tweets is", sentiment_mean)
# plot the sentiment
fig, ax = plt.subplots()
